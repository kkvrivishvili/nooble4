        ...
        <div className="border-t border-border/25 py-12 md:py-20">
          ...
          <div className="mx-auto max-w-3xl pb-4 text-center md:pb-12">
            ...
            <p className="text-lg text-muted-foreground">
              A comprehensive boilerplate with authentication, user management,
              payments, and AI integrations built-in.
            </p>
          </div>
          <div className="flex justify-center pb-4 md:pb-12" data-aos="fade-up">
            <div className="relative">
              <Image
                className="mx-auto max-w-none md:max-w-none mix-blend-multiply dark:mix-blend-lighten opacity-90 dark:opacity-100"
                src={FeaturesImage}
                width={1440}
                height={720}
                priority
              ...
              />
              <div className="absolute inset-0 bg-gradient-to-tr from-background/50 via-transparent to-background/50 dark:from-transparent dark:to-transparent" />
            </div>
          </div>
          {/* Items */}
          <div className="mx-auto grid max-w-sm gap-12 sm:max-w-none sm:grid-cols-2 md:gap-x-14 md:gap-y-16 lg:grid-cols-3">
            <article className="relative rounded-2xl bg-background/20 p-6 backdrop-blur-md dark:bg-background/10">
              <svg
                className="mb-3 fill-primary"
              ...
              <p className="text-muted-foreground">
                Complete auth system with OAuth, magic links, email
            ...
            <article className="relative rounded-2xl bg-background/20 p-6 backdrop-blur-md dark:bg-background/10">
              ...
              <p className="text-muted-foreground">
                Secure avatar uploads, profile management, and real-time
            ...
            <article className="relative rounded-2xl bg-background/20 p-6 backdrop-blur-md dark:bg-background/10">
              ...
              <p className="text-muted-foreground">
                Granular permissions with user roles, route protection, and
            ...
            <article className="relative rounded-2xl bg-background/20 p-6 backdrop-blur-md dark:bg-background/10">
              ...
              <p className="text-muted-foreground">
                Complete user and role management with system health monitoring
                and usage analytics.
              </p>
            </article>
            <article className="relative rounded-2xl bg-background/20 p-6 backdrop-blur-md dark:bg-background/10">
              ...
              <p className="text-muted-foreground">
                Track user actions and system events with detailed timestamps
                and activity trails.
              </p>
            </article>
            <article className="relative rounded-2xl bg-background/20 p-6 backdrop-blur-md dark:bg-background/10">
              ...
              <p className="text-muted-foreground">
                Optimized for Vercel deployment with type-safe database
