"""
Cliente para enviar acciones de consulta a Query Service.
"""
...
class QueryClient:
    """
    Cliente para enviar solicitudes de consulta RAG usando Domain Actions.
    
    Permite a otros servicios enviar solicitudes de generación de consulta
    y búsqueda de documentos al Query Service de forma asíncrona.
    """
    ...
    async def generate_query(
        ...
        Args:
            ...
            callback_queue: Cola para callbacks
